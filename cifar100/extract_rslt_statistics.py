...
if __name__ == '__main__':
    ...
    # Read Categories - CIFAR-100 has single category 'class' with 100 labels
    ...
    for category, types in categories.items() :
        ...
        # For CIFAR-100: category="class", but columns use "Label" as prefix
        search_prefix = "Label"  # CIFAR-100 uses "Label" instead of "class"
