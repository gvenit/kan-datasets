...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Testing script for Skin Cancer.')
    ...
    test_dataset = SkinCancerDataset(
        ...
        extra_transforms= get_basic_transforms(0, *model_config['input_img_dim'][-2:]),
    ...
    history = load_dict(hist_path) if os.path.exists(hist_path) else {'train': {}, 'val': {}, 'test': {}}
