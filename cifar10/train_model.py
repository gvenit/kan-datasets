...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Training script for Cifar100 Dataset.')
    ...
    from prepare_dataset import build_dataset, get_dataset, get_groups
    ...
    train_loader = IterableCIFAR10Dataset(
    ...
    val_loader = IterableCIFAR10Dataset(
