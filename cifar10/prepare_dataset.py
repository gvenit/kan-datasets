...
__train_file = "cifar10_train.pkl"
__test_file = "cifar10_test.pkl"
...
def build_dataset(force: bool = False) -> None:
    """
    Download CIFAR-10 (via torchvision) and save as pickle files.
    ...
    try:
        ...
        raise ImportError("torchvision is required to download CIFAR-10. Install with: pip install torchvision")

    # Download train and test sets
    train_ds = datasets.CIFAR10(root=str(__dataset_dir), train=True, download=True)
    test_ds = datasets.CIFAR10(root=str(__dataset_dir), train=False, download=True)
...
def get_dataset(
    ...
    """
    Load CIFAR-10 data for the requested subset.
