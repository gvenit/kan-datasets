...
class CIFAR10Dataset(Dataset):
    """
    Simple CIFAR-10 dataset wrapper for use with PyTorch DataLoader.
    ...
    def __getitems__(self, idx):
        ...
        if self.return_weights:
            # For CIFAR-10, all samples have equal weight
...
class IterableCIFAR10Dataset(IterableDataset):
    """
    Simple CIFAR-10 dataset wrapper for use with PyTorch DataLoader.
    Loads data using prepare_dataset.py's get_dataset() function.
    """
    def __init__(
        ...
        super(IterableCIFAR10Dataset, self).__init__()
