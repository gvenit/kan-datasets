...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(
        description='Training script for the MNIST Dataset.'
    )
    ...
    from kan_utils.models import FasterKAN, RSWAFF
    from kan_utils.utils import uses_momentum
    from prepare_dataset import get_class_names

    # MNIST: Calculate input features based on image size (grayscale, 1 channel)
    ...
    # MNIST: 10 class labels (digits 0-9)
