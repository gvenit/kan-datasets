...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(
        description='Extract result statistics for the MNIST Dataset.'
    )
    ...
    # Read Categories - MNIST has single category 'class' with 10 labels (digits 0-9)
    ...
    for category, types in categories.items() :
        ...
        # Find columns of the specified category; results use "Label" as column prefix
        search_prefix = "Label"
